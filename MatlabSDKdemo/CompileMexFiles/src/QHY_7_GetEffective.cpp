/*
 * Get image effective area,program will return start position and size.
 */
...
mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
	...
	ret = GetQHYCCDEffectiveArea(camhandle, x, y, sizex, sizey);
	if(ret == QHYCCD_ERROR)
	{
	...
	{
		printf("Get camera effective area successfully.\n");
		*retVal = 0;
	}
}
